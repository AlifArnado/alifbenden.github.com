              ...
              <div class="slider">
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="item active">
                      <img src="http://placehold.it/1200x400/F34336/F34336&text=BACKEND PROGRAMMER">
                    </div>
                    <div class="item">
                      <img src="http://placehold.it/1200x400/20BFA9/ffffff&text=NODE JS">
                    </div>
                    <div class="item">
                      <img src="http://placehold.it/1200x400/20BFA9/ffffff&text=PHP PROGRAMMING">
                    </div>
                    <div class="item">
                      <img src="http://placehold.it/1200x400/20BFA9/ffffff&text=FRONTEND PROGRAMMER">
                    </div>
                    <div class="item">
                ...
                <nav class="navbar navbar-default">
                  ...
                  <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img class="img-responsive" src="images.jpg"></a>
                    <span class="site-name"><b>ALIF BENDEN ARNADO</b></span>
                    <span class="site-description">Backend Developer</span>
                  </div>
                  ...
                  <div class="collapse navbar-collapse" id="mainNav" >
                    ...
                    <ul class="nav  navbar-nav navbar-right">
                      <li><a href="https://web.facebook.com/bendenalif"><i class="fa fa-facebook"></i></a></li>
                      <li><a href="https://twitter.com/Alif_Arnado"><i class="fa fa-twitter"></i></a></li>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="masthead well well-sm">
                            <h1>
                            <a href="index.asp"><span class="light text-primary">knowledge</span><span style="font-family: Lato, sans-serif; font-weight: 300; text-decoration: none; rgb(45,137,239);">|</span><span class="dark text-primary">Base</span></a>
                            </h1>
                          </div>
                        </div>
                      </div>
